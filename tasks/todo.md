...
- [x] Task 2: Improve diagnostics for the most common layout and configuration mistakes.
...
- [x] Task 3: Add a small maintained example project.
...
- [x] Checkpoint: release quality checks cover the onboarding path before widening customisation.
