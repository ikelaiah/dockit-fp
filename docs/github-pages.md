...
workflow to the installed release, such as `@v0.16.1`. It never follows
...
jobs:
  documentation:
    permissions:
      ...
      pages: write
      id-token: write
    uses: ikelaiah/dockit-fp/.github/workflows/publish-docs.yml@v0.16.1
    with:
      versioned: false
      release: latest
```

The maintained [single-version example](https://github.com/ikelaiah/dockit-fp/tree/v0.16.1/examples/single-version)
uses this form.
...
The maintained [historical example](https://github.com/ikelaiah/dockit-fp/tree/v0.16.1/examples/historical)
