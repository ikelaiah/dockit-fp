...
jobs:
  documentation:
    permissions:
      ...
      pages: write
      id-token: write
    uses: ikelaiah/dockit-fp/.github/workflows/publish-docs.yml@v0.11.2
    with:
      versioned: false
      release: latest
```
...
[single-version example](https://github.com/ikelaiah/dockit-fp/tree/v0.11.2/examples/single-version)
...
[historical example](https://github.com/ikelaiah/dockit-fp/tree/v0.11.2/examples/historical)
...
Always pin a released workflow such as `@v0.11.2`. Do not use `@main` for a
