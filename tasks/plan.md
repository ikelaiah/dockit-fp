...
- [x] Task 1: Add release regression coverage for the generated shell.
...
- [x] Task 2: Refine shared layout tokens and document rhythm.
...
- [x] Generated HTML remains valid and accessible by inspection.
- [x] Full test suite and current docs build remain green.

### Phase 2: component polish

- [x] Task 3: Polish code, tables and admonitions across theme/mode variants.
...
- [x] Task 4: Polish search, outline, page navigation and mobile navigation.
...
- [x] Classic/Paper/Midnight and Light/Dark combinations render coherently.
- [x] Fixture covers homepage cards, banner/no-banner, long prose, API/code,
      tables, callouts, search and previous/next navigation.

### Phase 3: dogfood and release documentation

- [x] Task 5: Update maintained fixture and DocKit-FP dogfood content only where
...
- [x] Task 6: Update ROADMAP and CHANGELOG with concise v0.12 release notes.
...
- [x] Current docs, visual fixture and historical release validation pass.
- [x] Git diff reviewed for scope, accessibility and accidental dependencies.
- [x] Release/PR/tag/Pages actions are reported separately if external GitHub
